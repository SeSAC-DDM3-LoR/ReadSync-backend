...
INSERT INTO "users" ("role", "provider", "provider_id", "login_id", "password", "status","updated_at") VALUES
                                                                                                           ('ADMIN', 'LOCAL', 'admin_01', 'admin', '$2a$10$ydzUynPZ1fuuKt9kxVA4f.BMGGl6ZB3DvgTft4rjKN6pVnKgRKJO2', 'ACTIVE',now()),
...
INSERT INTO "user_informations" ("preferred_genre", "experience", "level_id", "user_id", "user_name", "tag") VALUES
                                                                                                                 ('SF/판타지', 0, 1, 1, '관리자', to_char(floor(random() * 10000), 'fm0000')),
                                                                                                                 ('기술 서적', 0, 1, 2, '김철수', to_char(floor(random() * 10000), 'fm0000')),
                                                                                                                 ('고전 소설', 0, 1, 3, '이영희', to_char(floor(random() * 10000), 'fm0000')),
                                                                                                                 ('로맨스', 0, 1, 4, '박민수', to_char(floor(random() * 10000), 'fm0000'));
...
values  (1, '만세전', '염상섭', false, '주인공 ''나''는 기차 안에서 정자가 보낸 편지를 읽으며 그녀에 대한 연민과 자신의 태도를 성찰한다. 신호(고베)에 도착한 ''나''는 과거에 만났던 카페의 여급이 동반 자살했다는 소식을 듣고 묘한 충격을 받는다. 이후 음악학교에 다니는 을라를 찾아가 재회하는데, 을라는 반가워하며 기숙사 방으로 그를 안내한다. 대화 도중 을라는 병화의 소식을 전하며 은근히 경제적 도움을 바라는 눈치를 보이고, ''나''는 변해버린 그녀의 모습에 실망감과 거리감을 느낀다. 을라는 서울로 함께 가자고 제안하지만, ''나''는 그녀의 속물적인 태도에 거부감을 느끼며 작별을 고하고 나온다.', null, '1924-08-01 00:00:00.000000', 'https://drive.google.com/thumbnail?id=1fabz8_boAbxsalwTRE2KyKWN7UJQvjLA', 'FREE', 0, 'ko', 556, '2026-02-03 05:28:33.477160', '2026-02-03 05:28:33.477160'),
        (1, '구운몽 (九雲夢) - 상', '미상', false, '육관대사의 제자 성진은 용궁에 심부름을 다녀오다 팔선녀와 마주치며 세속의 부귀영화와 남녀 간의 정을 동경하게 된다. 이에 육관대사는 성진을 인간 세상으로 추방하여 양소유로 환생시킨다. 양소유는 뛰어난 재주와 외모를 지닌 인물로 성장하여 과거를 보러 가는 길에 진채봉, 계섬월 등 여러 여인과 인연을 맺는다. 이후 장원 급제하여 한림학사가 되고, 정사도의 딸 정경패를 얻기 위해 여장하고 거문고를 타는 등 기지를 발휘한다. 또한 국가의 위기 상황에서 출정하여 공을 세우고, 남장한 적경홍과 재회하며, 마침내 황제의 누이인 난양공주의 배필로 지목되는 등 온갖 부귀영화를 누리게 된다.', null, null, 'https://drive.google.com/thumbnail?id=1iyYUqY8zDAgQHmHDIMFCHBZo3zQTPcdC', 'FREE', 0, 'ko', 708, '2026-02-03 05:28:33.477160', '2026-02-03 05:28:33.477160'),
        (1, '구운몽 (九雲夢) - 하', '미상', false, '양소유는 과거에 급제하여 황제의 총애를 받고, 황제의 누이인 난양공주의 부마로 간택되지만 정소저와의 약혼을 이유로 거절하여 옥에 갇힌다. 때마침 토번이 침략하자 대원수가 되어 출정하고, 그 과정에서 자객 심요연과 용왕의 딸 백능파를 만나 인연을 맺고 승전한다. 돌아온 양소유는 황태후와 공주의 계략으로 정소저(영양공주)와 난양공주 두 명을 정실부인으로 맞이하고, 여섯 첩과 함께 부귀영화를 누린다. 말년에 인생의 무상함을 느끼던 중, 옛 스승인 노승을 만나 꿈에서 깨어 다시 성진으로 돌아오며 깨달음을 얻는다.', null, null, 'https://drive.google.com/thumbnail?id=1Td_By0yMOC0S_tsBtP2hVRX7CRZR1tV1', 'FREE', 0, 'ko', 723, '2026-02-03 05:28:33.477160', '2026-02-03 05:28:33.477160'),
        (1, '날개', '이상', false, '1930년대 지식인의 자아 분열과 무기력함을 다룬 이상의 대표적인 심리 소설이다. 주인공 ''나''는 매춘을 하는 아내에게 기생하며 볕이 들지 않는 33번지의 어두운 방에서 뒹굴며 지낸다. 그는 아내의 방에 손님이 들면 윗방에서 죽은 듯이 있거나 거리를 배회하며, 현실 감각을 잃고 끊임없이 자신의 내부로 침잠한다. 어느 날 아내가 자신에게 수면제인 아달린을 먹여왔다는 의심을 품게 된 ''나''는 집을 뛰쳐나와 미쓰꼬시 백화점 옥상에 오른다. 회색빛 도시를 내려다보던 그는 겨드랑이에서 인공의 날개가 돋았던 자국을 느끼며, 다시 한번 날아오르고자 하는 의지를 다진다.', null, null, 'https://drive.google.com/thumbnail?id=1ExZPDK4250EJqEdVGE_s2VXVNy7pfLrL', 'FREE', 0, 'ko', 170, '2026-02-03 05:28:33.477160', '2026-02-03 05:28:33.477160'),
        (1, '만복사저포기(萬福寺樗浦記)', '김시습', false, '전라도 남원에 사는 총각 양생은 만복사에서 부처와 저포 놀이를 하여 이긴 대가로 아름다운 여인을 만납니다. 두 사람은 개령동의 은밀한 처소에서 사흘간 사랑을 나누며 시를 읊고 즐기지만, 사실 여인은 왜구의 침입 때 죽은 귀신이었습니다. 여인의 부모를 만나 그녀의 정체를 알게 된 양생은 여인을 위해 장례와 재를 올려줍니다. 여인은 양생의 정성에 감사하며 타국에서 남자로 환생했다는 소식을 전하고 떠납니다. 이후 양생은 다시 장가들지 않고 지리산에 들어가 자취를 감춥니다.', null, null, 'https://drive.google.com/thumbnail?id=1iIzcQmuNnc_AaVZu2NAQHGskNXhLo7-k', 'FREE', 0, 'ko', 85, '2026-02-03 05:28:33.477160', '2026-02-03 05:28:33.477160'),
        (1, '무녀도', '김동리', false, '화자인 ''나''는 집안 대대로 내려오는 ''무녀도''라는 그림에 얽힌 내력을 할아버지로부터 전해 듣습니다. 경주 변두리의 퇴락한 집에서 무당 모화와 그녀의 귀먹은 딸 낭이는 세상과 단절된 채 살아갑니다. 모화는 낭이를 용신의 화신이라 믿으며 극진히 보살핍니다. 그러던 어느 날, 절로 보내졌던 모화의 아들 욱이가 십 년 만에 돌아옵니다. 하지만 욱이는 기독교인이 되어 성경을 읽고 기도를 올리는 등 모화의 무속 신앙과 정면으로 충돌합니다. 모화는 아들에게 잡귀가 들렸다고 믿으며 귀신을 쫓으려 하고, 욱이는 성경의 말씀을 전하며 어머니의 신앙을 부정합니다. 결국 모화는 아들에게 깃든 예수를 쫓기 위해 강력한 푸닥거리를 시작하며 모자간의 종교적 대립은 극에 달합니다.', null, null, 'https://drive.google.com/thumbnail?id=15UdHOGiKiEviemJrkTYjp5dMspfgQjAA', 'FREE', 0, 'ko', 162, '2026-02-03 05:28:33.477160', '2026-02-03 05:28:33.477160'),
        (1, '봄봄', '김유정', false, '데릴사위로 들어와 돈 한 푼 받지 않고 3년 7개월간 일해온 ''나''는 점순이의 키가 미처 자라지 않았다는 이유로 성례를 미루는 장인에게 불만을 느낍니다. 모내기를 하던 중 배가 아프다는 핑계로 일을 거부하자 장인은 뺨을 때리고 욕설을 퍼붓습니다. 결국 ''나''는 성례를 시켜주지 않을 거면 사경(임금)을 내놓으라며 장인을 구장에게 끌고 가려 합니다.', null, '1935-12-01 00:00:00.000000', 'https://drive.google.com/thumbnail?id=1P26zXjEXHm4T0RCk0teWkJ7am6F7Y2kV', 'FREE', 0, 'ko', 132, '2026-02-03 05:28:33.477160', '2026-02-03 05:28:33.477160'),
        (1, '사씨남정기(謝氏南征記)', '김만중', false, '명나라의 유현(유공)은 아들 유연수가 한림학사가 되자 어진 배필을 구합니다. 매파 주파의 추천과 관음찬 시험을 통해 현숙한 사정옥을 며느리로 맞이합니다. 유공은 사부인의 덕행을 칭찬하며 유언을 남기고 별세합니다. 유한림은 서른이 되도록 자식이 없자 사부인의 간곡한 권유로 양반가 출신의 교채란을 소실로 들이게 되는데, 고모인 두부인은 교씨의 미모 뒤에 숨겨진 성품을 우려하며 불길한 징조를 예견합니다.', null, null, 'https://drive.google.com/thumbnail?id=1CzPQf-8nj5mwaCRfoAXjIUncV6EPGYXy', 'FREE', 0, 'ko', 752, '2026-02-03 05:28:33.477160', '2026-02-03 05:28:33.477160'),
        (1, '수오재기', '정약용', false, '작가는 큰형님이 집의 이름을 ''수오재(자신을 지키는 집)''라고 지은 이유에 대해 의문을 품게 됩니다. 장기로 유배를 온 후에야 그는 세상 만물 중 가장 잃어버리기 쉽고 지키기 어려운 것이 바로 ''나'' 자신임을 깨닫습니다. 과거 공부와 관직 생활을 하며 자신을 잃고 떠돌았던 지난날을 깊이 반성하는 태도를 보입니다. 반면 본연의 자아를 잃지 않고 수오재에 머물렀던 큰형님의 삶을 예찬하며 수신의 중요성을 설파합니다. 결국 유배지에서 되찾은 ''나''와 함께 머물며 이 깨달음을 기록으로 남기기로 결심합니다.', null, null, 'https://drive.google.com/thumbnail?id=1Kb8cWA8Cza0oXNey7dhYHwfVtDsr0-vu', 'FREE', 0, 'ko', 18, '2026-02-03 05:28:33.477160', '2026-02-03 05:28:33.477160'),
        (1, '숙향전', '미상', false, '송나라의 선비 김전은 죽을 위기에 처한 거북을 구해주고, 후에 거북의 도움으로 목숨을 구하며 신비한 구슬을 얻습니다. 장희의 딸과 성혼한 김전은 태몽 끝에 천상에서 적강한 ''월궁소아'' 숙향을 낳습니다. 그러나 숙향이 다섯 살 되던 해 병란이 일어나 가족이 피란하던 중 도적을 만나게 되고, 부모는 어쩔 수 없이 숙향을 바위틈에 남겨두고 떠납니다. 홀로 남겨진 숙향은 동물들의 도움과 마을 사람들의 배려로 겨우 목숨을 부지하며 부모를 기다립니다.', null, null, 'https://drive.google.com/thumbnail?id=1AG-wQ1LlCkkIFQjPa96pux2DVetpD1Gy', 'FREE', 0, 'ko', 372, '2026-02-03 05:28:33.477160', '2026-02-03 05:28:33.477160'),
        (1, '장마', '윤흥길', false, '6.25 전쟁 중 장마가 계속되는 어느 여름 밤, 외할머니는 자신의 불길한 꿈이 현실이 될 것임을 직감하며 불안해한다. 완두를 까며 끝없이 꿈 이야기를 늘어놓는 외할머니와 달리, 어머니와 이모는 국군 소대장으로 나간 외삼촌 길준의 무사함을 믿으려 애쓴다. 마을 개들이 유난히 짖어대던 중 구장과 방수포를 쓴 사내들이 찾아와 외삼촌의 전사 소식을 전하는 통지서를 건넨다. 비극적인 소식 앞에 어머니는 절규하며 오열하지만, 외할머니는 자신의 예언이 적중했다는 사실에 묘한 승리감과 기괴한 흥분을 느낀다. 화자인 ''나(동만)''는 이 참혹한 상황 속에서 우연히 잡은 벌레인 ''하늘밥도둑''의 생사를 쥐고 묘한 권력감을 느끼며 집안의 비극을 지켜본다.', null, null, 'https://drive.google.com/thumbnail?id=1PiiGWy7O1rIoIHu-lL1ytx2MAn5fZBg6', 'FREE', 0, 'ko', 316, '2026-02-03 05:28:33.477160', '2026-02-03 05:28:33.477160'),
        (1, '장화홍련전', '미상', false, '평안도 철산군의 배무룡 좌수는 장화와 홍련이라는 두 자매를 얻지만, 부인 장씨가 일찍 세상을 떠납니다. 배좌수는 후처 허씨를 얻고 세 아들을 낳지만, 허씨는 전처의 딸들을 시기하여 죽일 음모를 꾸밉니다. 허씨는 쥐를 이용해 장화가 낙태를 한 것처럼 꾸며 배좌수를 속이고, 이를 믿은 좌수는 아들 장쇠를 시켜 장화를 연못에 빠뜨려 죽게 합니다. 장화가 죽자 하늘이 노하여 호랑이가 나타나 장쇠의 몸을 훼손하는 천벌을 내립니다. 언니를 잃은 홍련은 깊은 슬픔에 빠져 진실을 쫓으며, 꿈속에서 신령한 존재가 된 장화를 만나 불길한 징조를 확인합니다. 결국 자매의 억울한 원혼은 이 사건의 전말을 세상에 알리기 시작합니다.', null, null, 'https://drive.google.com/thumbnail?id=1xk-spyzX67-gX7jKUsDNNYqKVRVKk017', 'FREE', 0, 'ko', 136, '2026-02-03 05:28:33.477160', '2026-02-03 05:28:33.477160'),
        (1, '탁류(濁流)', '채만식', false, '금강이 흘러 닿는 항구 도시 군산. 몰락한 양반 출신의 정주사는 미두장(쌀 거래소) 주변을 맴도는 ''하바꾼'' 신세로 전락했다. 그는 돈 없이 미두를 하려다 젊은 애송이에게 멱살을 잡히고 봉변을 당하지만, 은행원 고태수의 개입으로 풀려난다. 가난과 빚, 많은 식구들 걱정에 자살 충동까지 느끼는 정주사는 쌀이라도 외상으로 얻어볼 요량으로 탑삭부리 한참봉의 쌀가게를 찾는다. 그곳에서 한참봉의 아내 김씨는 정주사의 딸 초봉이의 미모를 칭찬하며 중매를 서겠다고 제안하고, 정주사는 씁쓸한 현실 속에서도 그들과 장기를 두며 잠시 시름을 잊는다.', null, '1937-10-01 00:00:00.000000', 'https://drive.google.com/thumbnail?id=1apoNrt5GawVIiJ4mqR0O3BY0xA82XxAZ', 'FREE', 0, 'ko', 1327, '2026-02-03 05:28:33.477160', '2026-02-03 05:28:33.477160'),
        (1, '토끼전', '미상', false, '별주부 자라에게 속아 수궁으로 잡혀온 토끼는 용왕으로부터 병을 고치기 위해 간을 내놓으라는 엄명을 듣습니다. 절체절명의 위기 속에서 토끼는 자신의 간이 영약이라 산속 깊은 곳에 씻어 감추어 두고 왔다는 기지를 발휘합니다. 처음에는 의심하던 용왕도 토끼의 태연한 태도와 달마다 간을 출입한다는 감언이설에 속아 넘어가고, 간신 자가사리의 반대에도 불구하고 토끼를 극진히 대접하며 다시 육지로 보내기로 결정합니다.', null, null, 'https://drive.google.com/thumbnail?id=13Zi-mSGLhFT-vYOTXIH7k9B1PsWiW8RZ', 'FREE', 0, 'ko', 69, '2026-02-03 05:28:33.477160', '2026-02-03 05:28:33.477160'),
        (1, '허생전(許生傳)', '박지원', false, '남산 밑 묵적골에 살며 글읽기에만 매진하던 허생은 가난을 견디다 못한 아내의 냉소와 꾸짖음에 10년 기약 중 7년 만에 책을 덮고 집을 나섭니다. 한양 제일의 부자 변씨를 찾아간 허생은 아무런 담보도 없이 단도직입적으로 만 냥을 빌려달라고 청합니다. 변씨는 허생의 비범한 기상을 알아보고 흔쾌히 거금을 내주어 주위 사람들을 놀라게 합니다.', null, null, 'https://drive.google.com/thumbnail?id=13lwBj6BI_OjMRwz-8Imlf53q9s7MJW0p', 'FREE', 0, 'ko', 133, '2026-02-03 05:28:33.477160', '2026-02-03 05:28:33.477160'),
        (1, '김씨환생전', 'HOT8OY', false, '대한민국의 평범한 30대 IT 개발자 김민준은 살인적인 야근 끝에 정신을 잃는다. 다시 눈을 떴을 때, 그는 익숙한 천장이 아닌 서까래가 보이는 낯선 한옥에 누워 있었다. 상황을 파악하기도 전에 머슴 돌쇠가 들어와 그를 ''도련님''이라 부르며 깨운다. 거울 대신 물동이에 비친 자신의 얼굴이 수려한 외모의 조선시대 양반 ''김선우''임을 확인한 그는 경악한다. 하지만 곧 자신이 대감 댁의 금지옥엽 외아들이라는 사실과 엄청난 부자라는 것을 깨닫고, 현대의 지식을 이용해 조선에서 ''꿀 빠는'' 인생을 살기로 결심한다.', null, null, 'https://drive.google.com/thumbnail?id=1SfcAL72g5uOoszIvp04xAa1N-OHCtFUj', 'PREMIUM', 4900, 'ko', 86, '2026-02-03 05:28:33.477160', '2026-02-03 05:28:33.477160');
...
INSERT INTO "credits" ("user_id", "credit_type_id", "amount", "status", "created_at", "expired_at") VALUES
                                                                                                        (1, 1, 99999, 'ACTIVE', now(), now() + interval '30 days'),
